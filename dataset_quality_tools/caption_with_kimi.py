...
_PROMPT = os.getenv(
    "NEXIS_CAPTION_PROMPT",
    "Describe this video frame as a single text-to-video generation prompt "
    "(≤ 30 words, one sentence, no commentary). Explicitly name: the main "
    "subject, the scene/setting, the dominant colors, the motion or action, "
    "and the visual style (e.g. cinematic, aerial, slow motion).",
)
